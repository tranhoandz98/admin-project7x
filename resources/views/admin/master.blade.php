        ...
        <header class="header navbar navbar-expand-sm">
            ...
            <ul class="navbar-item theme-brand flex-row  text-center">
                <li class="nav-item theme-logo">
                    <a href="index.html">
                        <img src="{{ url('public') }}/assets/img/90x90.jpg" class="navbar-logo" alt="logo">
                    </a>
                </li>
            ...
            <ul class="navbar-item flex-row ml-md-auto">
                        ...
                        <div class="">
                            <a class="dropdown-item">
                                <div class="">
                                    ...
                                    <div class="media">
                                        <div class="user-img">
                                            <img class="usr-img rounded-circle" src="{{ url('public') }}/assets/img/90x90.jpg" alt="profile">
                                        </div>
                ...
                <p class="text-white p-2">Hi {{ Auth::user()->name }}</p>
                    ...
                    <div class="page-header">
                        ...
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><span>@yield('title-nav')</span></li>
                            </ol>
                        </nav>
