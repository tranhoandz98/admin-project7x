...
@section('title', 'Cập nhật Province')
@section('title-nav', 'Category')
@section('title-nav-child', 'Update Province')
@section('main')
            ...
            <div class="widget-content widget-content-area">
                <form action="{{ route('province.update', $province->id) }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="code" id="code" aria-describedby="helpId"
                                    placeholder="" value="{{ $province->code }}">
                                @error('code')
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="fullname" id="fullname" aria-describedby="helpId"
                                    placeholder="" value="{{ $province->fullname }}">
                                @error('fullname')
                                <span class="text-red">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col">
                            <div class="form-group">
                                <label for="isvalid == 0 ? 'checked' : ''" class="text-dark">Short name</label>
                                <input type="text" class="form-control" name="short_name" id="short_name"
                                    aria-describedby="helpId" placeholder="" value="{{ $province->short_name }}">
                            </div>
                        </div>
                        <div class="col">
                            <div class="form-group">
                                ...
                                <div class="n-chk">
                                    <label class="new-control new-checkbox new-checkbox-rounded checkbox-outline-success">
                                      <input type="radio" class="new-control-input" name="status" value="0" {{ $province->isvalid == 0 ? 'checked' : '' }}>
                                ...
                                <div class="n-chk">
                                    <label class="new-control new-checkbox new-checkbox-rounded checkbox-outline-danger" >
                                      <input type="radio" class="new-control-input" name="status" value="1"  {{ $province->isvalid == 1 ? 'checked' : '' }}>
