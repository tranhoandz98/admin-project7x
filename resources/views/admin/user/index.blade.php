                                    ...
                                    <td class="text-center">
                                        ...
                                        {{-- block or unblock --}}
                                            @if ($user->status == 1)
                                                    ...
                                                    <button class="mr-2 warning confirm lock  btn-no-style" type="">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                        ...
                                                        <form action="{{ route('user.changeStatus', $user->id) }}" method="post" class="inline-form">
                                                            @csrf
                                                            <input type="hidden" name="status" value="2" class="form-inline">
                                                        </form>
                                                    </button>
                                            @else
                                                <form action="{{ route('user.changeStatus', $user->id) }}" method="post" class="inline-form">
                                                    @csrf
                                                    <input type="hidden" name="status" value="1" class="form-inline">
                                                    <button class="mr-2 warning confirm unlock  btn-no-style "
                                                        type="">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                            viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                            stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                ...
                <div class="row">
                    <div class="col-md-6">
                        <label class="text-dark"><span>Display</span>
                            ...
                            </select> /Total 25 record</label>
                    </div>
                    <div class="col-md-6">
                        <div class="paginating-container pagination-solid justify-content-end">
                            <ul class="pagination">
                                <li class="prev"><a href="javascript:void(0);"><svg xmlns="http://www.w3.org/2000/svg"
                                ...
                                <li class="next"><a href="javascript:void(0);"><svg xmlns="http://www.w3.org/2000/svg"
                                            width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                            stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
