...
@section('title', 'Cập nhật district')
@section('title-nav', 'Category')
@section('title-nav-child', 'Update District')
@section('main')
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="code" id="code" aria-describedby="helpId"
                                    placeholder="" value="{{ $district->code }}">
                                @error('code')
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="fullname" id="fullname"
                                    aria-describedby="helpId" placeholder="" value="{{ $district->fullname }}">
                                @error('fullname')
                                <span class="text-red">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="short_name" id="short_name"
                                    aria-describedby="helpId" placeholder="" value="{{ $district->short_name }}">
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="province_id" id="province_id">
                                    ...
                                    @foreach ($provinces as $item)
                                        <option value="{{ $item->code }}"
                                            {{ $item->code == $district->province_id ? 'selected' : '' }}>
