            ...
            <div class="form-form-wrap">
                <div class="form-container">
                    <div class="form-content">
                        ...
                        @endif
                        <form class="text-left" method="POST" action="{{ url('admin/postLogin') }}">
                            @csrf
                            <div class="form">
                                ...
                                <div class="d-sm-flex justify-content-between">
                                    <div class="field-wrapper">
                                        <button type="" class="btn btn-primary submitLogin" value="">Log
                                            In</button>
                                    </div>
                                </div>
                            </div>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response.status == 1) {
                            ...
                            setTimeout(function(){window.top.location="{{url('admin')}}"} , 1000);
                        }
                    }
                });
            });
